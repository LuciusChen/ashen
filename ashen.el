...
`MODE' should be set to either `day', `night'."
  `(let* ((colors (ashen--palette ,mode))
          ...
          (badge-fg        (if (eq ,mode 'day) foreground background))
  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (font-lock-number-face (:foreground ,amber))
      ...
      (font-lock-bracket-face (:foreground ,comment))
      (font-lock-delimiter-face (:foreground ,comment))
      ...
      (linum (:background ,low-contrast-bg :foreground ,comment :slant normal :underline nil))
      ...
      (ansi-color-bright-yellow (:foreground ,gold :background ,gold :weight bold))
      ...
      (term-color-yellow (:foreground ,gold :background ,gold))
      ...
      (elisp-shorthand-font-lock-face (:slant italic :foreground ,iris))
      ...
      (gnus-group-mail-1-empty (:foreground ,comment :weight normal))
      (gnus-group-mail-2 (:foreground ,iris :weight normal))
      (gnus-group-mail-2-empty (:foreground ,comment :weight normal))
      (gnus-group-mail-3 (:foreground ,foam :weight normal))
      (gnus-group-mail-3-empty (:foreground ,comment :weight normal))
      ...
      (gnus-group-news-1-empty (:foreground ,comment :weight normal))
      (gnus-group-news-2 (:foreground ,iris :weight normal))
      (gnus-group-news-2-empty (:foreground ,comment :weight normal))
      (gnus-group-news-3 (:foreground ,foam :weight normal))
      (gnus-group-news-3-empty (:foreground ,comment :weight normal))
      (gnus-group-news-4 (:foreground ,love :weight normal))
      (gnus-group-news-4-empty (:foreground ,comment :weight normal))
      (gnus-group-news-5 (:foreground ,gold :weight normal))
      (gnus-group-news-5-empty (:foreground ,comment :weight normal))
      (gnus-group-news-6 (:foreground ,pine :weight normal))
      (gnus-group-news-6-empty (:foreground ,comment :weight normal))
      ...
      (org-modern-done (:inherit org-modern-label :weight bold :background ,leaf :foreground ,badge-fg))
      ...
      (org-modern-time-active (:inherit org-modern-label :background ,foam :foreground ,badge-fg))
      (org-modern-time-inactive (:inherit (org-modern-label org-modern-date-inactive)))
      (org-modern-todo (:inherit org-modern-label :weight bold :background ,love :foreground ,badge-fg))
      (org-modern-progress-complete (:background ,leaf :foreground ,badge-fg))
